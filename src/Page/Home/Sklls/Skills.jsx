...
const FaHtml5 = () => <div className="text-orange-600 text-5xl">🌐</div>;
const FaCss3Alt = () => <div className="text-blue-600 text-5xl">🎨</div>;
const SiTailwindcss = () => <div className="text-teal-500 text-5xl">🚀</div>;
const FaGithub = () => <div className="text-gray-800 text-5xl">📚</div>;
const FaJs = () => <div className="text-yellow-400 text-5xl">⚡</div>;
const SiJavascript = () => <div className="text-yellow-500 text-5xl">✨</div>;
const FaReact = () => <div className="text-blue-400 text-5xl">⚛️</div>;
...
const skills = [
    ...
    { 
        ...
        icon: <SiJavascript />, 
        level: 83,
        description: "DOM manipulation & events",
        category: "Programming"
    },
    { 
        name: "JavaScript ES6", 
...
const Skills = () => {
  ...
  const categories = ["All", "Frontend", "Programming", "Framework", "Backend", "Tools", "Design"];
  ...
  return (
    <section id="skills-section" className="py-20 bg-gradient-to-br from-green-50 via-white to-green-100 min-h-screen">
