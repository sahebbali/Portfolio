...
const FaHtml5 = () => <div className="text-orange-600 text-5xl font-bold">HTML5</div>;
const FaCss3Alt = () => <div className="text-blue-600 text-5xl font-bold">CSS3</div>;
...
const FaNode = () => <div className="text-green-600 text-5xl font-bold">NODE</div>;
const FaGithub = () => <div className="text-gray-800 text-5xl font-bold">GIT</div>;
const FaDatabase = () => <div className="text-green-700 text-5xl font-bold">DB</div>;
const FaTools = () => <div className="text-purple-600 text-5xl font-bold">🛠</div>;
  ...
  <div className="text-center mb-16">
    ...
    >
      ...
      <p className="text-gray-600 text-xl max-w-3xl mx-auto leading-relaxed">
        My technical skills span modern web technologies, design tools, and development practices.
      </p>
    </motion.div>
  </div>
);
              ...
              <div className="relative w-12 h-12">
                <svg className="w-12 h-12 transform -rotate-90" viewBox="0 0 48 48">
                  ...
                  <motion.circle
                    ...
                    animate={isVisible ? { 
                      strokeDashoffset: `${2 * Math.PI * 18 * (1 - skill.percentage / 100)}` 
                    } : {}}
                    transition={{ duration: 2, delay: (categoryIndex * 0.2) + (index * 0.1) + 0.5 }}
                  />
                  <defs>
